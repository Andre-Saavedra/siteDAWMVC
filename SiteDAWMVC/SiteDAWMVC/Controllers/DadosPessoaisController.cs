...
namespace SiteDAWMVC.Controllers
{
    public class DadosPessoaisController : Controller
    {
        ...
        public DadosPessoaisController(SiteDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("DadosPessoaisId,Nome,DataNascimento,Telemovel,Email")] DadosPessoais dadosPessoais)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("DadosPessoaisId,Nome,DataNascimento,Telemovel,Email")] DadosPessoais dadosPessoais)
        {
